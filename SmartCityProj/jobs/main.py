...
def simulate_journey(producer,device_id):
    while True:
        ...
        traffic_camera_data = generate_traffic_camera_data(device_id, vehicle_data['timestamp'], vehicle_data['location'], camera_id= 'Nikon-Cam-123')
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey( producer, device_id= 'shivani_travels')
